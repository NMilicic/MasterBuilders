...
namespace Web.Helpers
{
    public static class SearchHelper
    {
        ...
        {
            Data.Repository<Data.Domain.Tema> themeRepository = new Data.Repository<Data.Domain.Tema>();
            ...
            string theme = (model.ThemeId == "-1") ? "" : "Tema:" + themeRepository.GetById(System.Int32.Parse(model.ThemeId)).ImeTema;
